...
<head>
    ...
    <style>
        ...
        .btn-primary:hover, .btn-primary:active, .btn-primary:focus { background-color: #d63384 !important; border-color: #d63384 !important; }
        body { 
            background: linear-gradient(135deg, #ffc0cb 0%, #ffffff 100%) !important; 
